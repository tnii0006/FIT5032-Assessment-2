...
async function handleHealthCheck() {
  return new Response(JSON.stringify({
    ...
    functions: {
      total: 13,
      available: [
        'getUsers', 'registerUser', 'validateData', 'getSkills', 'addSkill',
        'updateSkill', 'deleteSkill', 'getSkillStats', 'processEmailData',
        'generateReport', 'backupData', 'analyzeSkills', 'sendNotification'
      ]
    }
  }), {
    status: 200,
